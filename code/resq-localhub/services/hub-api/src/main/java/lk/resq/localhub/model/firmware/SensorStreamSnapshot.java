...
public record SensorStreamSnapshot(
        ...
        String state,
        @JsonProperty("pressure_0_raw") Integer pressure0Raw,
        @JsonProperty("pressure_0_raw_valid") Boolean pressure0RawValid,
        @JsonProperty("pressure_1_raw") Integer pressure1Raw,
        @JsonProperty("pressure_1_raw_valid") Boolean pressure1RawValid,
        @JsonProperty("pressure_2_raw") Integer pressure2Raw,
        @JsonProperty("pressure_2_raw_valid") Boolean pressure2RawValid,
        @JsonProperty("hall_raw") Integer hallRaw,
        @JsonProperty("hall_raw_valid") Boolean hallRawValid,
