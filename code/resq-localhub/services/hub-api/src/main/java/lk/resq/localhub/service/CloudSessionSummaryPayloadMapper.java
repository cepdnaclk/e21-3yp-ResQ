...
public class CloudSessionSummaryPayloadMapper {
    ...
    public CloudSessionSummarySyncPayload map(SessionEndResponse session, Instant generatedAt) {
        ...
        return new CloudSessionSummarySyncPayload(
                ...
                summary == null ? null : summary.scoringVersion(),
                summary == null ? null : summary.overallScore(),
                summary == null ? null : summary.grade(),
                summary == null ? null : summary.depthScore(),
                summary == null ? null : summary.rateScore(),
                summary == null ? null : summary.recoilScore(),
                summary == null ? null : summary.handPlacementScore(),
                summary == null ? null : summary.compressionFractionScore(),
                summary == null ? null : summary.scoreCap(),
                summary == null ? null : summary.scoreCapReason(),
                summary == null ? null : summary.scoreProvisional(),
                summary == null ? null : summary.scoreValidCompressionCount(),
