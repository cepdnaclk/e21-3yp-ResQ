...
typedef enum {
    ...
    CAL_REASON_PRESSURE_SENSOR_SATURATED_USING_LAST_STABLE = 217,

    CAL_REASON_NVS_SAVE_FAILED = 300,
    CAL_REASON_CORRUPT = 301,
    CAL_REASON_UNSUPPORTED_SCHEMA = 302,
    CAL_REASON_IO_ERROR = 303,
    CAL_REASON_COMMIT_VERIFICATION_FAILED = 304,
    CAL_REASON_GENERATION_EXHAUSTED = 305,
    CAL_REASON_PROFILE_HASH_MISMATCH = 306,
